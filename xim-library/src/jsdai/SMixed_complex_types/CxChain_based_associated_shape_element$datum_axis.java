/*
 * $Id: CxChain_based_associated_shape_element\044datum_axis.java,v 1.1 2011/12/30 00:23:33 raira Exp $
 *
...
import jsdai.SExtended_geometric_tolerance_xim.CxDatum_axis;
...
public class CxChain_based_associated_shape_element$datum_axis extends CChain_based_associated_shape_element$datum_axis implements EMappedXIMEntity{
...
//			unsetId_x(context, this);			
	...
	public static void setMappingConstraints(SdaiContext context,
			CChain_based_associated_shape_element$datum_axis armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxChain_based_associated_shape_element.setMappingConstraints(context, armEntity);
		CxDatum_axis.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
		...
		CxDatum_axis.unsetMappingConstraints(context, armEntity);
	}
