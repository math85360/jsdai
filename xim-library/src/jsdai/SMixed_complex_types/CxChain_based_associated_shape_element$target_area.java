/*
 * $Id: CxChain_based_associated_shape_element\044target_area.java,v 1.1 2011/12/30 00:23:33 raira Exp $
 *
...
import jsdai.SGeometric_tolerance_xim.CxTarget_area;
...
public class CxChain_based_associated_shape_element$target_area extends CChain_based_associated_shape_element$target_area implements EMappedXIMEntity{
...
//			unsetId_x(context, this);			
	...
	public static void setMappingConstraints(SdaiContext context,
			CChain_based_associated_shape_element$target_area armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxChain_based_associated_shape_element.setMappingConstraints(context, armEntity);
		CxTarget_area.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
		...
		CxTarget_area.unsetMappingConstraints(context, armEntity);
	}
