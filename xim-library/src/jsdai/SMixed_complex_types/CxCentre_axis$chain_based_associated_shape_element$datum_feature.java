/*
 * $Id: CxCentre_axis\044chain_based_associated_shape_element\044datum_feature.java,v 1.1 2011/12/30 00:23:33 raira Exp $
 *
...
public class CxCentre_axis$chain_based_associated_shape_element$datum_feature extends CCentre_axis$chain_based_associated_shape_element$datum_feature implements EMappedXIMEntity{
...
//			unsetId_x(context, this);			
	...
	public static void setMappingConstraints(SdaiContext context,
			CCentre_axis$chain_based_associated_shape_element$datum_feature armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxChain_based_associated_shape_element.setMappingConstraints(context, armEntity);
		CxCentre_axis.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
		...
		CxCentre_axis.unsetMappingConstraints(context, armEntity);
	}
