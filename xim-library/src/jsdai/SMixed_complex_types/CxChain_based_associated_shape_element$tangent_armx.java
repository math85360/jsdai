/*
 * $Id: CxChain_based_associated_shape_element\044tangent_armx.java,v 1.1 2011/12/30 00:23:33 raira Exp $
 *
...
import jsdai.SDerived_shape_element_xim.CxTangent_armx;
...
public class CxChain_based_associated_shape_element$tangent_armx extends CChain_based_associated_shape_element$tangent_armx implements EMappedXIMEntity{
...
//			unsetId_x(context, this);			
	...
	public static void setMappingConstraints(SdaiContext context,
			CChain_based_associated_shape_element$tangent_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxChain_based_associated_shape_element.setMappingConstraints(context, armEntity);
		CxTangent_armx.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
		...
		CxTangent_armx.unsetMappingConstraints(context, armEntity);
	}
