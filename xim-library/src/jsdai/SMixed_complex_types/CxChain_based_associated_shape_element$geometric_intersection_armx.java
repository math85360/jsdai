/*
 * $Id: CxChain_based_associated_shape_element\044geometric_intersection_armx.java,v 1.1 2011/12/30 00:23:33 raira Exp $
 *
...
import jsdai.SDerived_shape_element_xim.CxGeometric_intersection_armx;
...
import jsdai.SShape_aspect_definition_schema.CGeometric_intersection;
import jsdai.lang.EEntity;
import jsdai.lang.SdaiContext;
import jsdai.lang.SdaiException;
import jsdai.libutil.EMappedXIMEntity;

public class CxChain_based_associated_shape_element$geometric_intersection_armx extends CChain_based_associated_shape_element$geometric_intersection_armx implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CGeometric_intersection.definition);
...
//			unsetId_x(context, this);			
	...
	public static void setMappingConstraints(SdaiContext context,
			CChain_based_associated_shape_element$geometric_intersection_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxChain_based_associated_shape_element.setMappingConstraints(context, armEntity);
		CxGeometric_intersection_armx.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
		...
		CxGeometric_intersection_armx.unsetMappingConstraints(context, armEntity);
	}
