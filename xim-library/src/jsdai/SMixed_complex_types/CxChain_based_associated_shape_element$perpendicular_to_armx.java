/*
 * $Id: CxChain_based_associated_shape_element\044perpendicular_to_armx.java,v 1.1 2011/12/30 00:23:33 raira Exp $
 *
...
import jsdai.SDerived_shape_element_xim.CxPerpendicular_to_armx;
...
import jsdai.SShape_aspect_definition_schema.CPerpendicular_to;
import jsdai.lang.EEntity;
import jsdai.lang.SdaiContext;
import jsdai.lang.SdaiException;
import jsdai.libutil.EMappedXIMEntity;

public class CxChain_based_associated_shape_element$perpendicular_to_armx extends CChain_based_associated_shape_element$perpendicular_to_armx implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CPerpendicular_to.definition);
...
//			unsetId_x(context, this);			
	...
	public static void setMappingConstraints(SdaiContext context,
			CChain_based_associated_shape_element$perpendicular_to_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxChain_based_associated_shape_element.setMappingConstraints(context, armEntity);
		CxPerpendicular_to_armx.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
		...
		CxPerpendicular_to_armx.unsetMappingConstraints(context, armEntity);
	}
