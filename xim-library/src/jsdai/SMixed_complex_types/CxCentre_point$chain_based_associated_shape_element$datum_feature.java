/*
 * $Id: CxCentre_point\044chain_based_associated_shape_element\044datum_feature.java,v 1.1 2011/12/30 00:23:33 raira Exp $
 *
...
import jsdai.SDerived_shape_element_xim.CxCentre_point;
...
import jsdai.SShape_aspect_definition_schema.*;
import jsdai.lang.EEntity;
import jsdai.lang.SdaiContext;
import jsdai.lang.SdaiException;
import jsdai.libutil.EMappedXIMEntity;

public class CxCentre_point$chain_based_associated_shape_element$datum_feature extends CCentre_point$chain_based_associated_shape_element$datum_feature implements EMappedXIMEntity{
...
/*	public boolean testDescription(EShape_aspect type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CCentre_of_symmetry$datum_feature.definition);
...
//			unsetId_x(context, this);			
	...
	public static void setMappingConstraints(SdaiContext context,
			CCentre_point$chain_based_associated_shape_element$datum_feature armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxChain_based_associated_shape_element.setMappingConstraints(context, armEntity);
		CxCentre_point.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
		...
		CxCentre_point.unsetMappingConstraints(context, armEntity);
	}
